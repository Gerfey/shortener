...
const (
	...
	URLShortener_ShortenJSON_FullMethodName    = "/shortener.URLShortener/ShortenJSON"
...
func (c *uRLShortenerClient) ShortenJSON(ctx context.Context, in *ShortenJSONRequest, opts ...grpc.CallOption) (*ShortenJSONResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedURLShortenerServer) ShortenJSON(context.Context, *ShortenJSONRequest) (*ShortenJSONResponse, error) {
...
func _URLShortener_ShortenJSON_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(URLShortenerServer).ShortenJSON(ctx, req.(*ShortenJSONRequest))
	}
	return interceptor(ctx, in, info, handler)
}
